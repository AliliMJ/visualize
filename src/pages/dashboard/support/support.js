...
const supportSchema = Yup.object().shape({
  message: Yup.string()
    ...
    .max(10, "La taille d'un message ne doit pas dépasser 255 characteres."),
});
const Support = () => {
    ...
    <div className="flex flex-col space-y-6">
      ...
      <div className="flex items-center space-x-2 p-2 bg-blue-100 rounded  ">
        ...
        <div className="border-l border-blue-200 px-2">
          Votre message sera envoyé à l'équipe de travail, vous aurez un retour
          dés que votre probléme soit résolu.
        </div>
      </div>
        ...
        >
          <Form className="flex flex-col  w-full md:max-w-xl space-y-3 ">
            <div className="text-gray-500">
              Écrivez un message descriptif où vous montienez votre probléme
              briévement :
            </div>
