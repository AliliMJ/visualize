...
import { useMap, MapProvider } from "../../hook/useMap";
      ...
      <Formik
        ...
        onSubmit={(values) => {
          files.length !== 0
            ...
            : window.alert("Vous devez fournir des documents");
        }}
      >
        {(formik) => (
          <>
            ...
            <div className="p-4 bg-white flex flex-col justify-items-center">
              <Form className="self-center border border-gray-600 rounded-md shadow-md py-5">
                ...
                <TextField
                  ...
                  type="text"
                />
                <div className="m-4 ml-6 p-1 border border-black rounded-lg  shadow-md w-96">
                  <div className="text-xl px-6 py-2">
                  ...
                  <div>
                    <h1 className="text-lg m-2 px-7">
                      Longitude : {lngLat[0].toFixed(4)}° E
                    </h1>
                    <h1 className="text-lg m-2 px-7">
                      Latitude : {lngLat[1].toFixed(4)}° N
                    </h1>
                  </div>
                </div>
                <div className="p-4 ml-2">
                  <MapProvider height={500} width={900}>
                  <Map getLngLat={changeLngLat} projects={[]} />
                  </MapProvider>
                ...
                <button
                  type="submit"
                  className="m-4 ml-6 p-4 text-2xl bg-green-500 text-white rounded-md"
                >
                  Ajouter
                </button>
              </Form>
